export const servicesData = [
  {
    ...
    deliverables: [
      ...
      "Subcontractor coordination & logistics",
      "Comprehensive OSHA & ISO safety compliance"
    ],
    metric: "100% On-Site Compliance"
  },
  {
    ...
    deliverables: [
      ...
      "Complex MEP (Mechanical, Electrical, Plumbing) integration",
      "LEED, BREEAM & WELL green building certification"
    ],
    metric: "LEED Gold & Platinum Standard"
  },
  {
    ...
    deliverables: [
      ...
      "Luxury architectural finishes & custom masonry",
      "Smart-building infrastructure pre-wiring"
    ],
    metric: "450+ Luxury Units Delivered"
  },
  {
    ...
    deliverables: [
      ...
      "Urban utility infrastructure & storm drainage",
      "Long-lifecycle seismic isolation bearings"
    ],
    metric: "120+ Year Design Lifespans"
  },
  {
    ...
    deliverables: [
      ...
      "Full MEP modernized infrastructure replacements",
      "Active-facility phased renovation without downtime"
    ],
    metric: "Zero Operational Interruption"
  },
  {
    ...
    deliverables: [
      ...
      "Value engineering & material cost mitigation",
      "Drone photogrammetry & LiDAR structural scanning"
    ],
    metric: "99.4% On-Schedule Milestone Rate"
  }
];
